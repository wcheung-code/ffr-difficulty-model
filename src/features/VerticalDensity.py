...
class VerticalDensity():
    ...
    def compute(self, chart):
        ...
        for orientation in self.regex.keys():
            ...
            vertical_density[orientation] = self._weighted_average(timedeltas)
